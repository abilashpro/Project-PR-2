...
const USERS_STORAGE_KEY = "promzivo-users";
const SESSION_STORAGE_KEY = "promzivo-session";
  ...
  return (
    <div>
      <section class="nav-box">
        <div class="nav1-box">
          <img class="logo-img" src={IMAGES.LOGO} alt="Promzivo" />
          <div class="nav-con1">
            <div class="menu-container">
              <div class="mega-menu">
                <ul>
                      ...
                      <ul>
                        <div class="box1">
                          ...
                          <div class="slide-bar5">
                            ...
                            <div class="cr-1">
                              <li>Promzivo Marketing Ebook</li>
                            </div>
                          </div>
                        </div>
                      </ul>
                      ...
                      <ul>
                        <div class="box1">
                          ...
                          <div class="slide-bar2">
                            ...
                            <div class="cr-1">
                              <li>7 Things You Could Do With Promzivo</li>
                            </div>
                            <div class="cr-1">
                  ...
                  <li class=" promzivoAI">PromzivoAI</li>
          ...
          <div class="navigation">
            ...
            <nav>
              <ul>
                ...
                <li
                  onClick={() =>
                    currentUser ? setIsProfileOpen(true) : openAuth("login")
                  }
                >
                  {currentUser ? "Profile" : "Log In"}
                </li>
                {!currentUser && (
                  <li onClick={() => openAuth("signup")}>Sign In</li>
                )}
              </ul>
            </nav>
          </div>
      ...
      <div class="first-box">
        <div class="first-box1">
          <div class="first-sec1">
            <h2 class="first-head1">Meet PromzivoAI</h2>
        ...
        <div class="third-page1">
          <div class="third-box">
            ...
            <div class="third-box1">
              ...
              <p class="third-para">
                Jaw-dropping Ai generated video posts for every single day of
                the month so you always know what to post next. That's the magic
                of PromzivoAI!
              </p>
          ...
          <div class="third-page2">
            <div class="third-img2">
              <img
                width="450px"
                class="th-im2"
                src={IMAGES.THIRDIMGTWO}
                alt=""
              />
            </div>
            <div class="third-box2">
              <h3 class="third-txt2">
                Time is Money, and Promzivo Saves Both!
              </h3>
              <p class="third-par2">
                We built PromzivoAI, so you have more time to run your business
                (and do more of what you love!) That's why our platform is your
                ultimate ally in content creation. Offering a brand new
                chat-based editor and delivering remarkable results
          ...
          <div class="third-page3">
            <div class="third-img3">
              <img
                width="450px"
                class="th-im3"
                src={IMAGES.THIRDIMGTHREE}
                alt=""
              />
            </div>
            <div class="third-box3">
              <h3 class="third-txt3">
                Generate and Publish - All in One Place!
              </h3>
              <p class="third-par3">
                PromzivoAI helps you manage your social media accounts right
                from the platform! saving you valuable time and money on video
                production, scheduling, and posting. Post directly to all your
                social media channels with AI-generated titles and descriptions
              </p>
          ...
          <div class="third-page4">
            <div class="third-img4">
              <img
                width="450px"
                class="th-im4"
                src={IMAGES.THIRDIMGFOUR}
                alt=""
              />
            </div>
            <div class="third-box4">
              <h3 class="third-txt4">
                Unlimited Videos, Infinite possibilities!{" "}
              </h3>
              <p class="third-par4">
                Whatever the Need, Whenever the Occasion, We've Got You! From
                marketing masterpieces to eye-catching listicles and from social
                media sensations to holiday-themed delights, PromzivoAI
                generates videos from thousands of fully customizable templates
                for every occasion.
              </p>
          ...
          <div class="third-page5">
            ...
            <div class="third-box5">
              ...
              <p class="third-par5">
                Unleash your creativity with unlimited premium stock footage
                from Getty Images and iStock. Paired with our professionally
                curated music tracks, your content will leave your competition
                in the dust!
              </p>
          ...
          <div class="third-page6">
            ...
            <div class="third-box6">
              ...
              <p class="third-par6">
                Looking for pixel-perfect adjustments? Promzivo has got your
                back! Whether you're in the mood for some hands-on editing or
                craving the convenience of automation, we've got you covered.
              </p>
      ...
      <div class="fourth-page">
        <div class="fourth-page1">
          <div class="fourth-box2">
            <h5 class="fourth-txt">What can I do with Promzivo:</h5>
            <h6 title="facebookads">facebookads</h6>
          </div>
          <img
            width="400px"
            class="fourth-img3"
            src={IMAGES.FOURTHIMG}
            alt=""
          />
        </div>
      </div>
          ...
          <div class="fifth-box1">
            <div class="fifth-txt-box1">
              <span class="fifth-txt1">
                Explore our massive <b>Facebook ad</b> <b>creator</b> library
              </span>
              <a class="fifth-txt-link1" href="v">
                View all Facebook ad templates
              </a>
            </div>
            <div class="fifth-ad-box1">
              <div class="fifth-im-box1">
                ...
                <div class="fif-part1 boxz-fif1">
                  <span class="fif-text-pa1">Preview</span>
              ...
              <div class="fifth-im-box2">
                <img
                  width="260px"
                  class="fifth-img2"
                  src={IMAGES.FIFTHIMGONE}
                  alt=""
                />
                <div class="fif-part2 boxz-fif2">
                  <span class="fif-text-pa2">Preview</span>
              ...
              <div class="fifth-im-box3">
                <img
                  width="260px"
                  class="fifth-img3"
                  src={IMAGES.FIFTHIMGTWO}
                  alt=""
                />
                <div class="fif-part3 boxz-fif3">
                  <span class="fif-text-pa3">Preview</span>
              ...
              <div class="fifth-im-box4">
                <img
                  width="260px"
                  class="fifth-img4"
                  src={IMAGES.FIFTHIMGTHREE}
                  alt=""
                />
                <div class="fif-part4 boxz-fif4">
                  <span class="fif-text-pa4">Preview</span>
          ...
          <div class="fifth-box2">
            <div class="fifth-txt-box2">
              <span class="fifth-txt2">
                Create a story in seconds with these prebuilt{" "}
                <b>Instagram story templates</b>
              </span>
              <a class="fifth-txt-link2" href="v">
                View all Instagram story templates
              </a>
            </div>
            <div class="fifth-ad-box1">
              <div class="fifth-im-box1">
          ...
          <div class="fifth-box3">
            <div class="fifth-txt-box3">
              <span class="fifth-txt3">
                Make an impression with our <b>YouTube intro templates</b>
              </span>
              <a class="fifth-txt-link3" href="v">
                View all YouTube intro templates
              </a>
            </div>
            <div class="fifth-ad-box1">
              <div class="fifth-im-box1">
          ...
          <div class="fifth-box4">
            <div class="fifth-txt-box4">
              <span class="fifth-txt4">
                Videos to amaze your audience's <b>Instagram feed</b>
              </span>
              <a class="fifth-txt-link4" href="v">
                View all Instagram feed templates
              </a>
            </div>
            <div class="fifth-ad-box1">
              <div class="fifth-im-box1">
          ...
          <div class="sixth-box1">
            <div class="sixth-txt-box1">
              <span class="sixth-txt1">
                <b>Video Maker For Every Business Type</b>
              </span>
            </div>
            <div class="sixth-ad-box1">
              <div class="sixth-im-box1">
                <img
                  width="300px"
                  class="sixth-img1"
                  src={IMAGES.SIXTHIMGONE}
                  alt=""
                />
                <div class="six-part1 boxs-six1">
                  <span class="six-text-pa1">See Templates</span>
                </div>
              ...
              <div class="sixth-im-box2">
                <img
                  width="260px"
                  class="sixth-img2"
                  src={IMAGES.SIXTHIMGTWO}
                  alt=""
                />
                <div class="six-part2 boxs-six2">
                  <span class="six-text-pa2">See Templates</span>
                </div>
              ...
              <div class="sixth-im-box3">
                <img
                  width="260px"
                  class="sixth-img3"
                  src={IMAGES.SIXTHIMGTHREE}
                  alt=""
                />
                <div class="six-part3 boxs-six3">
                  <span class="six-text-pa3">See Templates</span>
                </div>
              ...
              <div class="sixth-im-box4">
                <img
                  width="260px"
                  class="sixth-img4"
                  src={IMAGES.SIXTHIMGFOUR}
                  alt=""
                />
                <div class="six-part4 boxs-six4">
                  <span class="six-text-pa4">See Templates</span>
                </div>
            ...
            <div class="sixth-ad-box2">
              <div class="sixth-im-box6">
                <img
                  width="260px"
                  class="sixth-img6"
                  src={IMAGES.SIXTHIMGFIVE}
                  alt=""
                />
                <div class="six-part6 boxs-six6">
                  <span class="six-text-pa6">See Templates</span>
                </div>
              ...
              <div class="sixth-im-box7">
                <img
                  width="260px"
                  class="sixth-img7"
                  src={IMAGES.SIXTHIMGSIX}
                  alt=""
                />
                <div class="six-part7 boxs-six7">
                  <span class="six-text-pa7">See Templates</span>
                </div>
              ...
              <div class="sixth-im-box8">
                <img
                  width="260px"
                  class="sixth-img8"
                  src={IMAGES.SIXTHIMGSEVEN}
                  alt=""
                />
                <div class="six-part8 boxs-six8">
                  <span class="six-text-pa8">See Templates</span>
                </div>
                <div class="six-fitxt8">Recruiters</div>
              </div>
              <div class="sixth-im-box9">
                <img
                  width="260px"
                  class="sixth-img9"
                  src={IMAGES.SIXTHIMGEIGHT}
                  alt=""
                />
                <div class="six-part9 boxs-six9">
                  <span class="six-text-pa9">See Templates</span>
                </div>
                <div class="six-fitxt9">SaaS Companies</div>
              </div>
            </div>
        ...
        <div class="ninth-page1">
          ...
          <div class="ninth-con3">
            <nav>
              <ul>
                <div class="drop1">
                  <button class="dropdown12" onClick={drop}>
                    Company
                ...
                <div class="drop1">
                  <button class="dropdown13" onClick={drop1}>
                    Support
                ...
                <div class="drop1">
                  <button class="dropdown14" onClick={drop2}>
                    Product
                ...
                <div class="drop1">
                  <button class="dropdown15" onClick={drop3}>
                    Tools
          ...
          <div class="ninth-con2">
            <div class="nin-box5">
              <div class="nin-logo">
                <img width="120px" src={IMAGES.LOGO} alt="Promzivo" />
              </div>
              <p>
                Promzivo is the #1 video creation platform for businesses and
                agencies. We help our users create loads of visual content and
                unlimited videos to promote anything they want effectively.{" "}
              </p>
              <div class="nin-img">
                <img
                  width="100px"
                  class="ninth-img1"
                  src={IMAGES.NINETHIMGONE}
                  alt=""
                />
            ...
            <div class="nin-box6">
              ...
              <img
                width="140px"
                class="ninth-img2"
                src={IMAGES.NINETHIMGTHREE}
                alt=""
              />
              <img
                width="140px"
                class="ninth-img3"
                src={IMAGES.NINETHIMGFOUR}
                alt=""
              />
              <img
                width="140px"
                class="ninth-img4"
                src={IMAGES.NINETHIMGFIVE}
                alt=""
              />
            </div>
            <div class="nin-box7">
              ...
              <div class="ninth-font">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <img width="36px" src={IMAGES.NINETHIMGNINE} alt="youtube" />
                </a>
                <a
        ...
        >
          ...
          >
            ...
            <h2 id="login-title">
              {authMode === "login"
                ? "Log in to Promzivo"
                : "Create your Promzivo account"}
            </h2>
            <p className="login-description">
              Create and manage your videos in one place.
            </p>
